...
export function Header() {
    ...
    return (
        <header className="py-4 fixed inset-x-0 top-0  z-50 bg-primary-light dark:bg-header-dark text-primary-dark dark:text-white">
            <div className="w-11/12 mx-auto flex justify-between items-center">
                ...
                {/* Nav list */}
                <nav className={`${isNavOpen ? 'max-md:top-16' : 'max-md:top-[-400%]'} absolute z-50 md:static left-0 duration-500 max-md:w-full bg-gradient-to-b from-primary-light from-50% to-white md:to-primary-light dark:from-header-dark dark:to-header-dark max-md:shadow-lg max-md:shadow-white/40`}>
                    <ul className="md:flex">
                        <NavItem>
                            <NavLink to="/" className="max-md:block">Home</NavLink>
                        </NavItem>
                        <NavItem>
